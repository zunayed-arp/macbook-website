...
applyButton.addEventListener('click',function(){
	...
	const totalPriceFromTable = totalPrice.innerText;
	const totalProductsPrice = totalAfterPromo.innerText;
	//console.log(totalProductsPrice);
	const previousTotalProductsPrice = totalProductsPrice;
	//console.log(previousTotalProductsPrice);

	if(promoApplied == true){
		const newTotalProductsPrice = previousTotalProductsPrice * 0.2; 
		// console.log(newTotalProductsPrice);
		const newProductsPriceAfterPromo = previousTotalProductsPrice - newTotalProductsPrice;
		// console.log(newProductsPriceAfterPromo);
		 totalAfterPromo.innerText= newProductsPriceAfterPromo;
	}
	else{
		alert('Invalid Promo Code');
		totalAfterPromo.innerText = totalPriceFromTable;
